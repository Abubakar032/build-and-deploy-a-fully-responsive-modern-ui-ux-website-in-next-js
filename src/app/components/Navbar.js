...
const Navbar = () => {
  ...
  return (
    <div className="fixed top-0 bg-black right-0 left-0">
      ...
      {
        toggel ? 
      <div className=" h-screen w-[20vh] border bg-black right-0 top-0 absolute   lg:hidden ">
      <div className=''>
